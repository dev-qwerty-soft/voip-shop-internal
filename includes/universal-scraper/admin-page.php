...
/**
 * Admin Page for Content Scraper & Importer
 * Universal admin interface for scraping and importing content
 *
 * @package Universal_Site_Scraper
 * @version 1.0.0
 */

class Scraper_Admin_Page {
  private $scraper;
  private $importer;
  ...
  public function __construct() {
    ...
    $this->scraper = new Site_Content_Scraper();
    $this->importer = new Content_Importer();
  }
  ...
  public function enqueue_admin_scripts($hook) {
    ...
    wp_enqueue_style('product-import-admin', plugin_dir_url(__FILE__) . 'admin.css', [], '1.0.0');

    wp_enqueue_script('product-import-admin', plugin_dir_url(__FILE__) . 'admin.js', ['jquery'], '1.0.0', true);
  ...
  public function ajax_scrape_products() {
    ...
    // Save results to transient (temporary)
